...
6. Write actionPrompt describing what happens during the shot — character motion, gestures, expressions, environmental changes. Reference characters by name or role, not by physical appearance.
...
8. In actionPrompt and startFramePrompt fields, refer to characters by name (e.g., "Elena", "Marcus") or role (e.g., "the detective", "the woman"). Do NOT describe their physical appearance — reference images provide that. However, in the dialogue field, USE the actual character names naturally as they appear in the script.
